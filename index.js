...
const {
  ...
  console.log("Connecting THENU 𝘔𝘋 𝘉𝘖𝘛✅...");
  ...
  console.log('THENU 𝘔𝘋 𝘉𝘖𝘛 connected to whatsapp ✅')
  
  let up = `*THENU 𝘔𝘋 𝘉𝘖𝘛 𝘊𝘖𝘕𝘕𝘌𝘊𝘛𝘌𝘋*
